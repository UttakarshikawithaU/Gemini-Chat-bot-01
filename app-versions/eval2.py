...
def user_input(user_question, raw_text, ground_truth_answer, domain, csv_index):
    try:
        ...
        with open("C:\\Users\\VIBGYOR\\Desktop\\LLM-Mini-Resources\\TruthfulQA-main-BenchmarkNo.1\\TruthfulQA-main\\answers.csv", "a", newline='') as csvfile:
...
def main():
   ...
   # csv_path = "C:\\Users\\VIBGYOR\\Desktop\\LLM-Mini-Resources\\TruthfulQA-main-BenchmarkNo.1\\TruthfulQA-main\\answers.csv"
    df = pd.read_csv('C:\\Users\\VIBGYOR\\Desktop\\LLM-Mini-Resources\\TruthfulQA-main-BenchmarkNo.1\\TruthfulQA-main\\TruthfulQATesting_Phataka2.csv')
